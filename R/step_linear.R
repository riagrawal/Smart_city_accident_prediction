...
step_Lat_model <- step(Lat_model)
step_Long_model <- step(Long_model)
...
predict.data$Latitude <- predict(step_Lat_model, newdata = predict.data,type="response")
predict.data$Longitude <- predict(step_Long_model, newdata = predict.data,type="response")
